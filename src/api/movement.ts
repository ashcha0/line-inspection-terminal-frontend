...
export function getHeartbeat(): Promise<ApiResponse<{ sysTime: string; isRunning: boolean; currentPosition: number }>> { return request({ url: '/agv/movement/heartbeat', method: 'get' }) }
